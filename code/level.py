...
from code.Const import C_WHITE, WIN_HEIGHT, C_YELLOW, MENU_OPTION, EVENT_ENEMY, SPAW_TIME, C_GREEN, C_CYAN, \
...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(EntityFactory.get_entity(self.name.lower() + 'bg'))
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == EVENT_ENEMY:
                    choice = random.choice(('jinn1', 'Dragon', 'Medusa'))
            ...
            self.level_text(14, f'fps: {clock.get_fps():.0f}', C_YELLOW, (10, WIN_HEIGHT - 35))
            self.level_text(14, f'entidades: {len(self.entity_list)}', C_YELLOW, (10, WIN_HEIGHT - 20))
            pygame.display.flip()
            # Collisions
